...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=3714073156ltr&server=1">
...
<body>
    <div id="pma_navigation" data-config-navigation-width="162.995">
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=booking_cabinet&table=booking">`booking_cabinet`.`booking`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=booking_train&table=booking">`booking_train`.`booking`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=booking_train&table=users">`booking_train`.`users`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=booking_train&table=trip">`booking_train`.`trip`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=forum_news_it&table=comments">`forum_news_it`.`comments`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=forum_news_it&table=users">`forum_news_it`.`users`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=forum_news_it&table=posts">`forum_news_it`.`posts`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=clone_wordpress&table=wp_users">`clone_wordpress`.`wp_users`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=booking_cabinet&table=users">`booking_cabinet`.`users`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=booking_train&table=cities">`booking_train`.`cities`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="7c55327a4f375337456f64777446354f">
...
</span><small>Set to 0 to collapse navigation panel.</small></th><td><input type="number" name="NavigationWidth" id="NavigationWidth" class="custom field-error" value="162.995"><a class="restore-default hide" href="#NavigationWidth" title="Restore default value"><img src="themes/dot.gif" title="" alt="" class="icon ic_s_reload"></a>
        <dl class="inline_errors"><dd>Not a non-negative number!</dd></dl></td></tr></table>
</fieldset>
